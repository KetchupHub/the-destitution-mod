...
class DiscordClient
{
	...
	private static final _defaultID:String = "1104955579979542548";
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageKey = alrgey;
		presence.largeImageText = "The Destitution Mod";
		presence.smallImageKey = smalley;
