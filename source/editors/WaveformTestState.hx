...
class WaveformTestState extends MusicBeatState
{
	...
	override function create()
	{
		...
		wave = new WaveformSprite(WaveformDataParser.interpretFlxSound(FlxG.sound.music), WaveformOrientation.HORIZONTAL, FlxColor.fromRGB(195, 207, 209), Conductor.crochet / 500);
