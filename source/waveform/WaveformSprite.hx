...
class WaveformSprite extends MeshRender
{
  ...
  public static function buildFromFlxSound(sound:FlxSound, ?orientation:WaveformOrientation, ?color:FlxColor, ?duration:Float)
  {
    // TODO: Build waveform data from FlxSound.
    var data = null;
