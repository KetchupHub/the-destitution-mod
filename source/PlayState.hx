...
class PlayState extends MusicBeatState
{
	...
	public var ploinkyShatters:FlxSprite;
	...
	override function stepHit()
	{
		...
		if(markCam)
		{
			...
			if(curStep == (((curSection + 1) * 16) - 12))
			{
				//FlxG.camera.zoom -= 0.01;
			}
			if(curStep == (((curSection + 1) * 16) - 8))
			{
		...
		if(SONG.song.toLowerCase() == 'destitution')
		{
			switch(curBeat)
			{
				...
				case 720:
					...
					add(itemManFucked);
					ploinkyShatters = new FlxSprite(dad.x, dad.y);
					ploinkyShatters.frames = Paths.getSparrowAtlas("destitution/ploinky_shatter");
					ploinkyShatters.animation.addByPrefix("shatter", "shatter", 24, false);
					add(ploinkyShatters);
					ploinkyShatters.animation.play("shatter", true);
					FlxG.camera.flash(FlxColor.WHITE, 0.25);
				case 728:
					//iteem guy
					ploinkyShatters.visible = false;
				...
				case 1552:
					FlxTween.tween(rulezGuySlideScaleWorldFunnyClips, {alpha: 0}, (Conductor.crochet / 250) * 2);
					shoulderCam = false;
					//defaultCamZoom -= 0.1;
					FlxG.camera.flash();
					...
					boyfriendGroup.remove(boyfriend);
					boyfriend = new Boyfriend(0, 0, 'bf-mark', false);
					boyfriendGroup.add(boyfriend);
